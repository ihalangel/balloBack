...
const Model= require('./../time/models.js')
...
async function get_temporada(data) {
console.log("ME ejecuto desde store get temporada", data);
const temporada = await Model.find(data).catch(e => {
    console.log("error");
    console.log(e);
  });
